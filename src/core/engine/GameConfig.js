...
const KNOWLEDGE_WORLDS = {
    ...
    bunny_maze: { id: 'bunny_maze', name: 'Mê Cung Cà Rốt', icon: '🥕', color: 0xe67e22 },
    bunny_piano: { id: 'bunny_piano', name: 'Vườn Nhạc Bunnine', icon: '🎹', color: 0xec407a },
    world_explorer: { id: 'world_explorer', name: 'Bunny Khám Phá Thế Giới', icon: '🌍', color: 0x29b6f6 },
};
...
const GAME_DEFINITIONS = {
    ...
    bunny_maze: {
        gameId: 'bunny_maze',
        sceneKey: 'BunnyMazeScreen',
        name: 'Mê Cung Cà Rốt',
        world: 'bunny_maze',
        icon: '🥕',
        color: 0xe67e22,
        educationalGoal: 'Luyện tìm đường — quan sát lối đi, lập kế hoạch từng bước.',
        mechanics: ['path_find', 'key_door', 'explore'],
        levels: {
            1: {
                label: LEVEL_LABELS[1],
                title: 'Tìm Cà Rốt',
                rounds: 3,
                difficulty: {
                    complexity: 1, objectCount: 6, choiceCount: 0, timeLimit: 0,
                    memoryLoad: 1, distractionLevel: 0, hintLevel: 3,
                    interactionSteps: 1, questionComplexity: 1, visualComplexity: 1,
                    sequenceLength: 0, mathRange: 0, errorTolerance: 3,
                },
                scoring: {
                    accuracyWeight: 50, speedWeight: 10, comboWeight: 5,
                    explorationWeight: 20, perfectBonus: 10, difficultyBonus: 0,
                    hintPenalty: 2, starThresholds: DEFAULT_STAR_THRESHOLDS,
                },
                rewards: { baseXP: 50, gems: 5, threeStarXP: 25, perfectXP: 15, noHintXP: 10 },
                hints: [
                    'Đi tiếp ô sáng này nhé!',
                    'Chạm ô đất cạnh Bunnine để nhảy.',
                    'Cà rốt ở cuối lối đất đó!',
                ],
            },
            2: {
                label: LEVEL_LABELS[2],
                ...
                rounds: 3,
                difficulty: {
                    complexity: 2, objectCount: 8, choiceCount: 0, timeLimit: 0,
                    memoryLoad: 2, distractionLevel: 1, hintLevel: 2,
                    interactionSteps: 2, questionComplexity: 2, visualComplexity: 2,
                    sequenceLength: 0, mathRange: 0, errorTolerance: 2,
                },
                scoring: {
                    accuracyWeight: 50, speedWeight: 10, comboWeight: 5,
                    explorationWeight: 20, perfectBonus: 10, difficultyBonus: 5,
                    hintPenalty: 3, starThresholds: DEFAULT_STAR_THRESHOLDS,
                },
                rewards: { baseXP: 100, gems: 8, threeStarXP: 50, perfectXP: 25, noHintXP: 20 },
                hints: [
                    'Tìm chìa trước, rồi mới mở cổng.',
                    'Cổng gỗ chắn đường đến cà rốt.',
                    'Đi ô sáng để tìm chìa nào!',
                ],
            },
            3: {
                label: LEVEL_LABELS[3],
                ...
                rounds: 2,
                difficulty: {
                    complexity: 3, objectCount: 9, choiceCount: 0, timeLimit: 0,
                    memoryLoad: 2, distractionLevel: 2, hintLevel: 1,
                    interactionSteps: 2, questionComplexity: 3, visualComplexity: 2,
                    sequenceLength: 0, mathRange: 0, errorTolerance: 1,
                },
                scoring: {
                    accuracyWeight: 50, speedWeight: 10, comboWeight: 5,
                    explorationWeight: 15, perfectBonus: 10, difficultyBonus: 10,
                    hintPenalty: 4, starThresholds: [45, 78],
                },
                rewards: { baseXP: 200, gems: 12, threeStarXP: 100, perfectXP: 50, noHintXP: 40 },
                hints: [
                    'Tránh bạn đang dạo, rồi đi ô sáng nào!',
                    'Bạn ốc sên không giận — chỉ cần đi ô khác.',
                    'Tìm chìa, mở cổng, rồi tới cà rốt!',
                ],
            },
        },
        awards: [
            { id: 'bm_little_explorer', name: 'Nhà Thám Hiểm Bé', icon: '🗺️', rarity: 'common',
              description: 'Bạn đã tìm ra lối đi!',
              reward: { xp: 30 }, condition: { type: 'complete_any_level' } },
            { id: 'bm_gate_opener', name: 'Người Mở Cổng', icon: '🔑', rarity: 'rare',
              description: 'Bạn tìm được đường bí mật!',
              reward: { xp: 80 }, condition: { type: 'complete_level', level: 2 } },
            { id: 'bm_maze_master', name: 'Bậc Thầy Mê Lối', icon: '🥕', rarity: 'epic',
              description: 'Bạn đã vượt mê cung khó nhất!',
              reward: { xp: 150, gems: 10 }, condition: { type: 'three_stars', level: 3 } },
        ],
        stickers: [
            { id: 'bm_carrot', name: 'Cà Rốt Vàng', icon: '🥕', rarity: 'common',
              hint: 'Hoàn thành Màn 1', condition: { type: 'complete_level', level: 1 } },
            { id: 'bm_key', name: 'Chìa Gỗ', icon: '🔑', rarity: 'common',
              hint: 'Hoàn thành Màn 2', condition: { type: 'complete_level', level: 2 } },
            { id: 'bm_gate', name: 'Cổng Vườn', icon: '🚪', rarity: 'rare',
              hint: 'Hoàn thành Màn 3', condition: { type: 'complete_level', level: 3 } },
            { id: 'bm_star', name: 'Sao Lối Đi', icon: '⭐', rarity: 'rare',
              hint: 'Đạt 3 sao ở bất kỳ màn nào', condition: { type: 'three_stars_any' } },
            { id: 'bm_snail', name: 'Bạn Ốc Sên', icon: '🐌', rarity: 'epic',
              hint: 'Chơi 3 lượt ở Mê Cung Cà Rốt', condition: { type: 'plays', count: 3 } },
            { id: 'bm_hat', name: 'Mũ Thám Hiểm', icon: '👑', rarity: 'legendary',
              hint: 'Đạt 3 sao ở Màn 3', condition: { type: 'three_stars', level: 3 } },
        ],
    },
    ...
    bunny_piano: {
        gameId: 'bunny_piano',
        sceneKey: 'BunnyPianoScreen',
        name: 'Vườn Nhạc Bunnine',
        world: 'bunny_piano',
        icon: '🎹',
        color: 0xec407a,
        educationalGoal: 'Đọc nốt trên khuông nhạc năm dòng, tìm phím piano tương ứng, rồi nghe âm thanh.',
        mechanics: ['listen', 'staff_reading', 'melody'],
        levels: {
            1: {
                label: LEVEL_LABELS[1],
                title: 'Nhạc Sĩ Bé',
                rounds: 3,
                difficulty: {
                    complexity: 1, objectCount: 3, choiceCount: 8, timeLimit: 0,
                    memoryLoad: 1, distractionLevel: 0, hintLevel: 3,
                    interactionSteps: 1, questionComplexity: 1, visualComplexity: 1,
                    sequenceLength: 4, mathRange: 0, errorTolerance: 3,
                },
                scoring: {
                    accuracyWeight: 55, speedWeight: 5, comboWeight: 5,
                    explorationWeight: 20, perfectBonus: 10, difficultyBonus: 0,
                    hintPenalty: 2, starThresholds: DEFAULT_STAR_THRESHOLDS,
                },
                rewards: { baseXP: 50, gems: 5, threeStarXP: 25, perfectXP: 15, noHintXP: 10 },
                hints: [
                    'Nhìn nốt đang sáng trên khuông nhạc, rồi bấm phím piano.',
                    'Nốt thấp nằm gần phía dưới khuông nhạc.',
                    'Nốt đang sáng là nốt cần bấm.',
                ],
            },
            2: {
                label: LEVEL_LABELS[2],
                title: 'Người Khám Giai Điệu',
                rounds: 3,
                difficulty: {
                    complexity: 2, objectCount: 5, choiceCount: 8, timeLimit: 0,
                    memoryLoad: 1, distractionLevel: 0, hintLevel: 2,
                    interactionSteps: 2, questionComplexity: 2, visualComplexity: 2,
                    sequenceLength: 6, mathRange: 0, errorTolerance: 2,
                },
                scoring: {
                    accuracyWeight: 55, speedWeight: 10, comboWeight: 5,
                    explorationWeight: 15, perfectBonus: 10, difficultyBonus: 5,
                    hintPenalty: 3, starThresholds: DEFAULT_STAR_THRESHOLDS,
                },
                rewards: { baseXP: 100, gems: 8, threeStarXP: 50, perfectXP: 25, noHintXP: 20 },
                hints: [
                    'Nốt cao hơn nằm phía trên khuông nhạc.',
                    'Đọc vị trí nốt, rồi tìm phím piano.',
                    'Khuông nhạc vẫn hiện — không cần nhớ thuộc.',
                ],
            },
            3: {
                label: LEVEL_LABELS[3],
                ...
                rounds: 2,
                difficulty: {
                    complexity: 3, objectCount: 8, choiceCount: 8, timeLimit: 0,
                    memoryLoad: 2, distractionLevel: 1, hintLevel: 1,
                    interactionSteps: 2, questionComplexity: 3, visualComplexity: 2,
                    sequenceLength: 10, mathRange: 0, errorTolerance: 1,
                },
                scoring: {
                    accuracyWeight: 50, speedWeight: 15, comboWeight: 5,
                    explorationWeight: 15, perfectBonus: 10, difficultyBonus: 10,
                    hintPenalty: 4, starThresholds: [45, 78],
                },
                rewards: { baseXP: 200, gems: 12, threeStarXP: 100, perfectXP: 50, noHintXP: 40 },
                hints: [
                    'Đọc vị trí nốt trên khuông, rồi tìm phím.',
                    'Theo từng nốt một — không cần vội.',
                    'Nốt càng cao trên khuông, phím càng sang phải.',
                ],
            },
        },
        awards: [
            { id: 'bp_little_musician', name: 'Nhạc Sĩ Bé', icon: '🎵', rarity: 'common',
              description: 'Bạn đã chơi giai điệu đầu tiên!',
              reward: { xp: 30 }, condition: { type: 'complete_any_level' } },
            { id: 'bp_melody_explorer', name: 'Người Khám Giai Điệu', icon: '🎼', rarity: 'rare',
              description: 'Bạn đã theo hết giai điệu!',
              reward: { xp: 80 }, condition: { type: 'complete_level', level: 2 } },
            { id: 'bp_composer', name: 'Nhà Soạn Nhạc', icon: '🎹', rarity: 'epic',
              description: 'Bạn đã chơi trọn một giai điệu dài!',
              reward: { xp: 150, gems: 10 }, condition: { type: 'three_stars', level: 3 } },
        ],
        stickers: [
            { id: 'bp_note', name: 'Nốt Vàng', icon: '🎵', rarity: 'common',
              hint: 'Hoàn thành Màn 1', condition: { type: 'complete_level', level: 1 } },
            { id: 'bp_score', name: 'Bản Nhạc', icon: '🎼', rarity: 'common',
              hint: 'Hoàn thành Màn 2', condition: { type: 'complete_level', level: 2 } },
            { id: 'bp_stage', name: 'Sân Khấu', icon: '🎭', rarity: 'rare',
              hint: 'Hoàn thành Màn 3', condition: { type: 'complete_level', level: 3 } },
            { id: 'bp_star', name: 'Sao Giai Điệu', icon: '⭐', rarity: 'rare',
              hint: 'Đạt 3 sao ở bất kỳ màn nào', condition: { type: 'three_stars_any' } },
            { id: 'bp_butterfly', name: 'Bướm Nhạc', icon: '🦋', rarity: 'epic',
              hint: 'Chơi 3 lượt ở Vườn Nhạc Bunnine', condition: { type: 'plays', count: 3 } },
            { id: 'bp_crown', name: 'Vương Miện Piano', icon: '👑', rarity: 'legendary',
              hint: 'Đạt 3 sao ở Màn 3', condition: { type: 'three_stars', level: 3 } },
        ],
    },

    world_explorer: {
        gameId: 'world_explorer',
        sceneKey: 'WorldExplorerScreen',
        name: 'Bunny Khám Phá Thế Giới',
        world: 'world_explorer',
        icon: '🌍',
        color: 0x29b6f6,
        educationalGoal: 'Luyện quan sát quốc kỳ, nhớ thủ đô, và khám phá điều thú vị về các nước trên thế giới.',
        mechanics: ['flag_match', 'capital_match', 'fact_discover'],
        levels: {
            1: {
                label: LEVEL_LABELS[1],
                ...
                rounds: 3,
                difficulty: {
                    complexity: 1, objectCount: 4, choiceCount: 4, timeLimit: 0,
                    memoryLoad: 1, distractionLevel: 0, hintLevel: 3,
                    interactionSteps: 1, questionComplexity: 1, visualComplexity: 1,
                    sequenceLength: 0, mathRange: 0, errorTolerance: 3,
                },
                scoring: {
                    accuracyWeight: 55, speedWeight: 5, comboWeight: 5,
                    explorationWeight: 25, perfectBonus: 10, difficultyBonus: 0,
                    hintPenalty: 2, starThresholds: DEFAULT_STAR_THRESHOLDS,
                },
                rewards: { baseXP: 50, gems: 5, threeStarXP: 25, perfectXP: 15, noHintXP: 10 },
                hints: [
                    'Nhìn màu và hình trên lá cờ, rồi chọn tên nước.',
                    'Bunny gợi ý: chọn nước gần nhau trên bản đồ nhé!',
                    'Lá cờ đang sáng — hãy đọc tên nước đó.',
                ],
            },
            2: {
                label: LEVEL_LABELS[2],
                title: 'Người Tìm Thủ Đô',
                rounds: 3,
                difficulty: {
                    complexity: 2, objectCount: 4, choiceCount: 4, timeLimit: 0,
                    memoryLoad: 2, distractionLevel: 0, hintLevel: 2,
                    interactionSteps: 2, questionComplexity: 2, visualComplexity: 2,
                    sequenceLength: 0, mathRange: 0, errorTolerance: 2,
                },
                scoring: {
                ...
                rewards: { baseXP: 100, gems: 8, threeStarXP: 50, perfectXP: 25, noHintXP: 20 },
                hints: [
                    'Tìm tên nước trước, rồi mới tìm thủ đô.',
                    'Thủ đô thường là thành phố lớn nhất hoặc nổi tiếng nhất.',
                    'Đọc lại tên nước trên lá cờ, rồi chọn thành phố.',
                ],
            },
            3: {
                label: LEVEL_LABELS[3],
                title: 'Nhà Khám Phá Địa Cầu',
                rounds: 2,
                difficulty: {
                    complexity: 3, objectCount: 4, choiceCount: 4, timeLimit: 0,
                    memoryLoad: 2, distractionLevel: 1, hintLevel: 1,
                    interactionSteps: 3, questionComplexity: 3, visualComplexity: 2,
                    sequenceLength: 0, mathRange: 0, errorTolerance: 1,
                },
                scoring: {
                    accuracyWeight: 50, speedWeight: 10, comboWeight: 5,
                    explorationWeight: 20, perfectBonus: 10, difficultyBonus: 10,
                    hintPenalty: 4, starThresholds: [45, 78],
                },
                rewards: { baseXP: 200, gems: 12, threeStarXP: 100, perfectXP: 50, noHintXP: 40 },
                hints: [
                    'Nhớ châu lục: Á, Âu, Phi, Mỹ, Đại Dương.',
                    'Đọc kỹ điều thú vị rồi trả lời câu hỏi nhỏ.',
                    'Bunny tin bạn — nhìn lại lá cờ và tên nước.',
                ],
            },
        },
        awards: [
            { id: 'we_first_explorer', name: 'Nhà Thám Hiểm Bé', icon: '🐰', rarity: 'common',
              description: 'Bạn vừa khám phá quốc gia đầu tiên!',
              reward: { xp: 30 }, condition: { type: 'complete_any_level' } },
            { id: 'we_curious_traveler', name: 'Người Du Hành Tò Mò', icon: '✈️', rarity: 'rare',
              description: 'Bạn đã khám phá 10 quốc gia!',
              reward: { xp: 80 }, condition: { type: 'explore_count', count: 10 } },
            { id: 'we_globe_explorer', name: 'Nhà Khám Phá Địa Cầu', icon: '🌍', rarity: 'epic',
              description: 'Bạn đã chinh phục chuyến đi khó nhất!',
              reward: { xp: 150, gems: 10 }, condition: { type: 'three_stars', level: 3 } },
        ],
        stickers: [
            { id: 'we_passport', name: 'Hộ Chiếu Bunny', icon: '📘', rarity: 'common',
              hint: 'Hoàn thành Màn 1', condition: { type: 'complete_level', level: 1 } },
            { id: 'we_globe', name: 'Địa Cầu Bé', icon: '🌍', rarity: 'common',
              hint: 'Hoàn thành Màn 2', condition: { type: 'complete_level', level: 2 } },
            { id: 'we_plane', name: 'Máy Bay Du Hành', icon: '✈️', rarity: 'rare',
              hint: 'Hoàn thành Màn 3', condition: { type: 'complete_level', level: 3 } },
            { id: 'we_star', name: 'Sao Lữ Hành', icon: '⭐', rarity: 'rare',
              hint: 'Đạt 3 sao ở bất kỳ màn nào', condition: { type: 'three_stars_any' } },
            { id: 'we_balloon', name: 'Khinh Khí Cầu', icon: '🎈', rarity: 'epic',
              hint: 'Chơi 3 lượt ở Bunny Khám Phá Thế Giới', condition: { type: 'plays', count: 3 } },
            { id: 'we_crown', name: 'Vương Miện Địa Cầu', icon: '👑', rarity: 'legendary',
              hint: 'Đạt 3 sao ở Màn 3', condition: { type: 'three_stars', level: 3 } },
        ],
    },
};
